...
type AddMomentReq struct {
	...
	Attachment     json.RawMessage `json:"attachment" binding:"required"`      //图片/音频/视频的url集合
	AttachmentType int             `json:"attachment_type" binding:"required"` //类型 1-图片  2-音频  3-视频文件

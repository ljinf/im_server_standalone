...
type RelationshipRepository interface {
	...
	SelectApplyFriendshipList(ctx context.Context, userId string, page, pageSize int) ([]model.ApplyFriendshipList, error)
	SelectApplyOne(ctx context.Context, userId, targetId string) (*model.ApplyFriendshipList, error)
	DelApplyFriendship(ctx context.Context, userId, targetId string) error

	// 关系
	CreateRelationship(ctx context.Context, list ...model.RelationshipList) error
	SelectRelationshipList(ctx context.Context, userId string, relationshipType, page, pageSize int) ([]model.RelationshipList, int, error)
	SelectRelationshipOne(ctx context.Context, userId, targetId string, relationshipType int) (*model.RelationshipList, error)
	UpdateRelationship(ctx context.Context, info *model.RelationshipList) error
	DelRelationship(ctx context.Context, userId, targetId string, relationshipType int) error
}
...
func (r *relationshipRepository) SelectApplyOne(ctx context.Context, userId, targetId string) (*model.ApplyFriendshipList, error) {
...
func (r *relationshipRepository) SelectApplyFriendshipList(ctx context.Context, userId string, page, pageSize int) ([]model.ApplyFriendshipList, error) {
...
func (r *relationshipRepository) DelApplyFriendship(ctx context.Context, userId, targetId string) error {
...
func (r *relationshipRepository) SelectRelationshipList(ctx context.Context, userId string, relationshipType, page, pageSize int) ([]model.RelationshipList, int, error) {
...
func (r *relationshipRepository) SelectRelationshipOne(ctx context.Context, userId, targetId string, relationshipType int) (*model.RelationshipList, error) {
...
func (r *relationshipRepository) DelRelationship(ctx context.Context, userId, targetId string, relationshipType int) error {
